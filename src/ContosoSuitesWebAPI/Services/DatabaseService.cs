...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get bookings by minimum date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("Minimum Date")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get all missing hotel rooms.")]
